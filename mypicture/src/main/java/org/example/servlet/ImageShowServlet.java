...
public class ImageShowServlet extends HttpServlet {
    ...
    static {//白名单允许获取图片内容：还可以设计为白名单+黑名单的方式
        whiteList.add("http://localhost:8080/mypicture/");
        whiteList.add("http://localhost:8080/mypicture/index.html");
        whiteList.add("http://39.105.25.39:8080/picture/");
        whiteList.add("http://39.105.25.39:8080/picture/index.html");
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //本地图片的绝对路径
        String path = ImageServlet.IMAGE_DIR + image.getPath() + image.getImageName();
